const config = {
  ...
  docuUrl: process.env.docuURL || 'https://sabineberland.github.io',
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://github.com/sabineberland/apidoc-workshop-docu_registry.git',
  ...
  generationResult: {
    srcLocation: 'https://github.com/sabineberland/your_github_username.github.io.git',
    branch: process.env.docuBranch || 'master',
